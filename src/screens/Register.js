...
const Register = (props) => {
    ...
    return (
      <View style={styles.container}>
          ...
          {success.status && (<Alert message={success.message} closeAlert={closeAlert} />)}
          <Image
          ...
          <View style={styles.formContainer}>
            <View style={styles.formWrapper}>
                ...
                >
                    Already have an account ? Click <Text style={styles.clickHere} onPress={()=>toLogin()}>Login</Text>
                </Text>
            </View>
          </View>
          <Image
